...
class Test:
    ...
    def startTest(self):
        ...
        security_question_answer_input = self.browser.find_element(By.XPATH, Util.SECURITY_QUESTION_ANSWER_XPATH).send_keys("")
        ...
        if current_url == "https://juice-shop.herokuapp.com/#/login":
            fr.log("Test was able to create an account using empty security question answer field, test failed.")
            ...
            return fr.getReturnData(False, f"[✖] ({test_name}) Test was able to create an account using empty security question answer field, test failed.")
        else:
            fr.log("Login page not reached, assuming no account was created using empty security question answer field, test passed.")
            fr.log("Stopping test.")
            fr.log("====================================================================")
            
            return fr.getReturnData(True, f"[✔] ({test_name}) Login page not reached, assuming no account was created using empty security question answer field, test passed.")