...
class Test:
    ...
    def startTest(self):
        ...
        if current_url == "https://juice-shop.herokuapp.com/#/login":
            fr.log("Test was able to create an account using empty password field, test failed.")
            ...
            return fr.getReturnData(False, f"[✖] ({test_name}) Test was able to create an account using empty password field, test failed.")
        else:
            fr.log("Login page not reached, assuming no account was created using empty password field, test passed.")
            fr.log("Stopping test.")
            fr.log("====================================================================")
            
            return fr.getReturnData(True, f"[✔] ({test_name}) Login page not reached, assuming no account was created using empty password field, test passed.")
